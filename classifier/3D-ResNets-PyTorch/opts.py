...
def parse_opts():
    ...
    parser.add_argument('--label_path',
                        default=None,
                        help='either segments/label for action det, or meta path for rate')

    parser.add_argument('--inference_label_path',
                        default=None,
                        help='either path to inference labels')

    parser.add_argument('--frame_dir',
                        default=None,
                        help='Directory path of frames')

    parser.add_argument('--inference_frame_dir',
                        default=None,
                        help='Directory path of inference frames')

    parser.add_argument('--video_id_path',
                        default=None,
                        help='video IDs by train, val, test split')

    parser.add_argument('--image_size',
                        default=224,
                        type=int,
                        help='size of image, square')

    parser.add_argument('--window_size',
                        default=48,
                        type=int,
                        help='size of sliding window, temporally')
