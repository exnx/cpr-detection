...
def get_train_utils(opt, model_parameters):
    ...
    train_data = get_training_data(opt.segment_label_path, opt.video_id_path,
                                   'train', opt.frame_dir, opt.image_size)
...
def get_val_utils(opt):
    ...
    val_data, collate_fn = get_validation_data(opt.segment_label_path, opt.video_id_path,
                                   'val', opt.frame_dir, opt.image_size)
...
def get_inference_utils(opt):
    ...
    inference_data, collate_fn = get_inference_data(opt.segment_label_path, opt.video_id_path,
                                   'test', opt.frame_dir, opt.image_size)
