...
def get_train_utils(opt, model_parameters):
    ...
    # for rate pred.
    train_data = get_training_data(opt.label_path, opt.video_id_path,
                                   'train', opt.frame_dir, opt.image_size, opt.window_size)
...
--image_size 224 \
--result_path /vision2/u/enguyen/results/run4_res18_inference_ep20 \
--dataset rate \
--n_classes 2 \
--batch_size 24 \
--n_threads 24 \
--tensorboard \
--resume_path /vision2/u/enguyen/results/rate_pred/run4_res18/save_20.pth \
--n_val_samples 1 \
--inference \
--no_train \
--no_val \
